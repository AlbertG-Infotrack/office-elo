...
from elo import compute, build, margin, START
...
assert margin("") == 1.0 and margin("11-0, 11-0") == 1.5 and margin("11-3, 11-8") == 0.5 + 22 / 33
assert compute([{"date": "2026-09-01", "winner": "A", "loser": "B", "score": "11-0, 11-0"}])[0]["A"] == START + 24
print("ok")
